<template>
  <Layout>
    <div class="overflow-x-hidden">
      ...
      >
        <h2 class="font-bold mb-6" id="projects">Here are some of my current focus areas:</h2>
        ...
        <ul class="text-lg sm:text-xl space-y-6">
          <li class="checkmark">
            ...
            <div class="text-lg text-gray-600">
              Wrangling in this behemoth is no trivial task. Key areas of
              interest is its CI/CD pipeline, testing, and ITOM:CMDB data
              integration.
            </div>
          </li>
          <li class="checkmark">
            ...
            <div class="text-lg text-gray-600">
              Never a fun topic, but in todays corporate landscape this is
              the utmost importance for on-going operational integrity.
            </div>
          </li>
          <li class="checkmark">
            <div>Agile ＆ SAFe</div>
    ...
    <div class="overflow-x-hidden border-gray-200 border-b">
      <div class="get-to-know-me container-inner mx-auto text-xl pb-16 relative">
        <h2 class="font-bold mb-6" id="about">Little perspective from me:</h2>
        ...
        <div class="flex flex-col sm:flex-row justify-between items-center mb-16">
          <div>
            <g-image
              src="../../static/onlyOne.jpeg"
              alt="theOne"
              class="w-32 h-32 rounded-full mb-8 lg:mb-0"
            />
          </div>
          <div class="flex-1 text-lg sm:text-xl ml-6">
            Silent, I go thru the days and nights. No footprint of mine shall be found as I travel
            where no one dares to tread. Whatever, just enjoy being outdoors with the ones I love!
          </div>
        </div>
        ...
        <div class="flex flex-col sm:flex-row justify-between items-center mb-16">
          ...
          >Below is a TED Talk video on how to be impactful, yet anonymous...</div>
        </div>
        <div class="responsive-container">
          <iframe
            class="responsive-iframe w-full h-full top-0 left-0 border-0"
            src="https://www.youtube.com/embed/0O_boW9YA7I"
            style="border:0;"
    ...
    <div class="overflow-x-hidden">
      <div class="contact-me bg-background-secondary pt-16">
        <div class="container-inner mx-auto text-xl pb-4 relative">
          ...
          <p class="mb-12">
            You can find me by several ways such as
            <a
              href="https://www.linkedin.com/in/timothyhalley/"
            >LinkedIn</a> or
            even
            <a href="https://www.strava.com/athletes/76201">Strava</a>,
            otherwise drop me a note below.
          </p>
    ...
    <div class="newsletter bg-background-tertiary">
      <div class="container-inner mx-auto py-16 pb-8 text-center textl-xl">
        <h2 class="text-2xl font-bold mb-8">Join my idea emailer</h2>

        <div class="w-4/5 mx-auto mb-8">
          <p
            class="mb-8 text-lg sm:text-xl"
          >Hand crafted and curated list of topics to explore each month.</p>
