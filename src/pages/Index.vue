  ...
  <Layout>
    ...
    <div class="container-inner mx-auto">
      <p class="text-lg sm:text-xl">
        ...
        <a href="https://cascadezen.com">personal website</a>. I added more features and decided to release it as an open source project. Check it out on
        <a
          href="https://github.com/theblueox/gridsome-portfolio-starter"
        >GitHub</a> or check out the
        <a href="https://www.youtube.com/watch?v=tmJ_mJw8xec">screencast I did</a>. Feel free to use it for your own site or projects! Lorem, ipsum dolor sit amet consectetur adipisicing elit. Minima, repellat. Dolores iure, quas perspiciatis rerum quaerat atque eum repellat autem.
      </p>
      ...
      <div class="get-to-know-me container-inner mx-auto text-xl pb-16 relative">
        ...
        <div class="responsive-container">
          <iframe
            ...
            src="https://www.youtube.com/embed/DydIK14AvXI"
            style="border:0;"
